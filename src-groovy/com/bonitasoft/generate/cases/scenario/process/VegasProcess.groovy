...
class VegasProcess {
    ...
    VegasProcess(APIAccessor apiAccessor){
        this.apiAccessor = apiAccessor
    }

    def long startCase(long userId, String version) {
        apiAccessor.getProcessAPI().startProcess(userId, apiAccessor.getProcessAPI().getProcessDefinitionId('Vegas', version)).getId()
	}
